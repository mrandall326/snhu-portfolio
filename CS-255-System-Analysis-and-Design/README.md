...
- Short papers and analysis write-ups
...
- Identifying system users and their goals
- Modeling processes and data flow
- Communicating system behavior through diagrams
...
- Create UML diagrams that accurately reflect system behavior
- Write concise, organized system requirements
- Think like both a developer and an analyst
- Communicate technical ideas in a way non-technical stakeholders can understand
